...
contract BitsLinearCurve is Ownable {
    ...
    {
        // We only calculate changes for buying 1 or more Bits
        if (numItems == 0) {
        ...
        // Account for the creator fee, a flat percentage of the buy amount
        creatorFee = inputValue.mulWadUp(creatorFeeMultiplier);

        // Account for the reflection fee, a flat percentage of the buy amount
